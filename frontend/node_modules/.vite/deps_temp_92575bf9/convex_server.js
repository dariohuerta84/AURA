...
var Expression = class {
   ...
   */
  constructor() {
    __publicField5(this, "_isExpression");
    __publicField5(this, "_value");
  }
};
...
var IndexRange = class {
   ...
   */
  constructor() {
    __publicField7(this, "_isIndexRange");
  }
};
...
var IndexRangeBuilderImpl = class _IndexRangeBuilderImpl extends IndexRange {
  constructor(rangeExpressions) {
    super();
    __publicField8(this, "rangeExpressions");
...
var SearchFilter = class {
   ...
   */
  constructor() {
    __publicField9(this, "_isSearchFilter");
  }
};
...
var SearchFilterBuilderImpl = class _SearchFilterBuilderImpl extends SearchFilter {
  constructor(filters) {
    super();
    __publicField10(this, "filters");
    __publicField10(this, "isConsumed");
...
var QueryInitializerImpl = class {
  constructor(tableName) {
    __publicField11(this, "tableName");
    this.tableName = tableName;
  }
...
var QueryImpl = class _QueryImpl {
  constructor(query) {
    ...
    __publicField11(this, "tableNameForErrorMessages");
...
async function getTransactionMetrics() {
  ...
  try {
    ...
    if ((_a2 = e.message) == null ? void 0 : _a2.includes("Unknown async operation")) {
      throw new Error(
...
async function invokeMutation(func, argsStr, visibility) {
  ...
  const mutationCtx = {
    ...
    runQuery: (reference, args2, options) => (options == null ? void 0 : options.useStaleSnapshot) ? runUdf("snapshotQuery", reference, args2, options == null ? void 0 : options.transactionLimits) : runUdf("query", reference, args2, options == null ? void 0 : options.transactionLimits),
    runMutation: (reference, args2, options) => runUdf("mutation", reference, args2, options == null ? void 0 : options.transactionLimits)
  };
...
function assertNotBrowser() {
  ...
  const isRealBrowser = ((_b2 = (_a2 = Object.getOwnPropertyDescriptor(globalThis, "window")) == null ? void 0 : _a2.get) == null ? void 0 : _b2.toString().includes("[native code]")) ?? false;
  if (isRealBrowser) {
    console.error(
...
async function invokeQuery(func, argsStr, visibility) {
  ...
  const queryCtx = {
    ...
    runQuery: (reference, args2, options) => {
      if (options == null ? void 0 : options.useStaleSnapshot) {
        throw new Error(
          "`useStaleSnapshot` is only supported in mutations, not queries."
        );
      }
      return runUdf("query", reference, args2, options == null ? void 0 : options.transactionLimits);
    }
  };
...
async function runUdf(udfType, f, args, transactionLimits) {
  ...
  if (transactionLimits) {
    syscallArgs2.transactionLimits = transactionLimits;
  }
...
var Crons = class {
  constructor() {
    __publicField12(this, "crons");
    __publicField12(this, "isCrons");
    this.isCrons = true;
    this.crons = {};
  }
  /** @internal */
...
var HttpRouter = class {
  constructor() {
    __publicField13(this, "exactRoutes", /* @__PURE__ */ new Map());
    __publicField13(this, "prefixRoutes", /* @__PURE__ */ new Map());
    __publicField13(this, "isRouter", true);
    __publicField13(this, "route", (spec) => {
    ...
    __publicField13(this, "getRoutes", () => {
    ...
    __publicField13(this, "lookup", (path, method) => {
      var _a2;
      method = normalizeMethod(method);
      const exactMatch = (_a2 = this.exactRoutes.get(path)) == null ? void 0 : _a2.get(method);
      if (exactMatch) return [exactMatch, method, path];
      const prefixes = this.prefixRoutes.get(method) || /* @__PURE__ */ new Map();
      const prefixesSorted = [...prefixes.entries()].sort(
        ([prefixA, _a3], [prefixB, _b2]) => prefixB.length - prefixA.length
      );
    ...
    __publicField13(this, "runRequest", async (argsStr, requestRoute) => {
...
var InstalledComponent = class {
  constructor(definition, name) {
    __publicField14(this, "_definition");
    __publicField14(this, "_name");
...
function use(definition, options) {
  ...
  const httpPrefix = options == null ? void 0 : options.httpPrefix;
...
function defineComponent(name, options) {
  ...
  const ret = {
    ...
    _exportTree: {},
    _onInitCallbacks: {},
    env: createEnvRefs(`component "${name}"`, options == null ? void 0 : options.env),
...
function defineApp(options) {
  ...
  const env = options == null ? void 0 : options.env;
  if (env !== void 0) {
...
// ../node_modules/convex/dist/esm/server/audit_logging.js
...
// ../node_modules/convex/dist/esm/server/log.js
var log = {
  audit,
  vars
};
...
var __publicField15 = (obj, key, value) => __defNormalProp15(obj, typeof key !== "symbol" ? key + "" : key, value);
var TableDefinition = class {
  /**
   * @internal
   */
  constructor(documentType) {
    __publicField15(this, "indexes");
    __publicField15(this, "stagedDbIndexes");
    __publicField15(this, "searchIndexes");
    __publicField15(this, "stagedSearchIndexes");
    __publicField15(this, "vectorIndexes");
    __publicField15(this, "stagedVectorIndexes");
    __publicField15(this, "validator");
    this.indexes = [];
...
var SchemaDefinition = class {
  ...
  constructor(tables, options) {
    __publicField15(this, "tables");
    __publicField15(this, "strictTableNameTypes");
    __publicField15(this, "schemaValidation");
    this.tables = tables;
