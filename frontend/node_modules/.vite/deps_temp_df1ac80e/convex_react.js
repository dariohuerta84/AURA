...
function makeComparable(v2) {
  ...
  if (v2 instanceof CommitTsPlaceholder) {
    return [2, MAX_INT64];
  }
  if (typeof v2 === "number") {
    return [3, v2];
...
var ConvexReactClient = class {
  ...
  get sync() {
    ...
    this.cachedSync = this.options.baseClient ?? new BaseConvexClient(
      this.address,
      () => {
      },
...
function usePaginatedQueryInternal(query, args, options, throwOnError = true) {
  ...
  const [results, maybeLastResult, maybeError] = (0, import_react4.useMemo)(() => {
    var _a2, _b2;
    ...
    for (const pageKey of currState.pageKeys) {
      ...
      if (currResult instanceof Error) {
        if (currResult.message.includes("InvalidCursor") || currResult instanceof ConvexError && typeof currResult.data === "object" && ((_a2 = currResult.data) == null ? void 0 : _a2.isConvexSystemError) === true && ((_b2 = currResult.data) == null ? void 0 : _b2.paginationError) === "InvalidCursor") {
          logger.warn(
          ...
          return [allItems, void 0, currResult];
        }
      }
    ...
    return [allItems, currResult, void 0];
  }, [
    resultsObject,
    currState.pageKeys,
...
function insertAtPosition(options) {
  ...
  for (const query of queries) {
    ...
    const key = JSON.stringify(
      Object.fromEntries(
        Object.entries(query.args).map(([k, v2]) => [
          k,
          k === "paginationOpts" ? v2.id : v2
        ])
      )
    );
...
function usePaginatedQuery_experimental(queryOrOptions, args, options) {
  ...
  if (typeof (initialOptions == null ? void 0 : initialOptions.initialNumItems) !== "number" || initialOptions.initialNumItems < 0) {
    throw new Error(
      `\`options.initialNumItems\` must be a positive number. Received \`${initialOptions == null ? void 0 : initialOptions.initialNumItems}\`.`
    );
  }
  ...
  if (result instanceof Error) {
    if (result.message.includes("InvalidCursor") || result instanceof ConvexError && typeof result.data === "object" && ((_a2 = result.data) == null ? void 0 : _a2.isConvexSystemError) === true && ((_b2 = result.data) == null ? void 0 : _b2.paginationError) === "InvalidCursor") {
      logger.warn(
...
function ConvexProviderWithAuth({
  ...
  const authState = (0, import_react6.useMemo)(
    () => ({
      isLoading,
      isAuthenticated,
  ...
  return import_react6.default.createElement(ConvexAuthContext.Provider, { value: authState }, import_react6.default.createElement(
  ...
  ), import_react6.default.createElement(ConvexProvider, { client }, children), import_react6.default.createElement(
